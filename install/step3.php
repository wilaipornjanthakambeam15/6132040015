...
if (defined('ROOT_PATH')) {
  ...
  if (!$error) {
    ...
    if (!$error) {
      ...
      echo '<p>คุณควรปรับ chmod ให้ไดเร็คทอรี่ <em>inc/</em> (และไดเร็คทอรี่อื่นๆที่คุณได้ปรับ chmod ไว้ก่อนการติดตั้ง) ให้เป็น 644 ก่อนดำเนินการต่อ (ถ้าคุณได้ทำการปรับ chmod ไว้ด้วยตัวเอง)</p>';
      echo '<p>เมื่อเรียบร้อยแล้ว กรุณา<b>เข้าระบบ</b>เพื่อตั้งค่าที่จำเป็นอื่นๆโดยใช้ขื่ออีเมล์และรหัสผ่านของผู้ดูแลระบบ</p>';
      echo '<p><a href="../index.php" class="button large admin"><button type="button" class="btn btn-success"> เข้าระบบ </button></a></p>';
    } else {
      ...
      echo '<ul>'.implode('', $content).'</ul>';
      echo '<p><a href="." class="button large admin"><button type="button" class="btn btn-success"> ลองใหม่ </button></a></p>';
    }
  }
}
