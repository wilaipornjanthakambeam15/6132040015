...
if (defined('ROOT_PATH')) {
  ...
  echo '</ul>';
  echo '<a href="index.php?step=1" class="button large pink"><button type="button" class="btn btn-success"> ตรวจสอบใหม่ </button></a>&nbsp;<a href="index.php?step=2" class="button large save"><button type="button" class="btn btn-primary"> ดำเนินการต่อ </button></a>';
